...
public class DatosGrid extends VerticalLayout {
    ...
    private VerticalLayout crearTw(Dialog dialog) {
        ...
        guardar.addClickListener(e -> {
            ...
            DateFormat dateFormat = new SimpleDateFormat("dd-MM-yyyy"); // Creamos un formato de fecha
            Date fechaDate;
            try {
            ...
            tw.setFecha(fechaDate); // Le ponemos el valor del campo de texto al objeto


            URL url; // Creamos una variable para la url
            URLConnection con; // Creamos una variable para la conexion
            Gson gson = new GsonBuilder().setDateFormat("dd-MM-yyyy").create();
            ; // Creamos una variable para el gson
